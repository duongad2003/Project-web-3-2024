        ...
        <div class="container-fluid bg-dark fixed-top">
            <div class="container topbar bg-light d-none d-lg-block ">
                <div class="d-flex justify-content-between">
                    <div class="top-info ps-2">
                        ...
                        <small class="me-3"><i class="fas fa-envelope me-2 text-secondary"></i><a href="#" class="text-dark">Email@Example.com</a></small>
                    </div>
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-dark navbar-expand-xl ">
                    <a href="ad-index.php"><img src="./img/demo.png" class="img-fluid" alt="logo"></a>
                    ...
                    <div class="collapse navbar-collapse bg-dark" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            <a href="adindex.php" class="nav-item nav-link">Trang chủ</a>
                            <a href="adshop.php" class="nav-item nav-link">Sản phẩm</a>
                            <div class="menu-dropdown">
                                <a href="adshop.php" class="nav-item nav-link">Danh mục <i class="fa-solid fa-caret-down"></i></a>
                                <div class="menu-dropdown-content">
                                    ...
                                    ?>
                                        <div class="column">
                                            ...
                                            ?>
                                                <a href="adproduct-detail.php?id=<?php echo $SEproduct['product_id'] ?>"><?php echo $SEproduct['product_name'] ?></a>
                            ...
                            <a href="ad-cgy-show.php" class="nav-item nav-link">Quản Trị</a>
                        </div>
                        <!-- search -->
                        <div class="d-flex m-3  ">
                            ...
                            ?>
                            <a href="adcart.php" class="position-relative me-4 my-auto">
